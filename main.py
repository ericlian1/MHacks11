...
flags.DEFINE_integer("input_size", 5, "Input size [1]")
flags.DEFINE_integer("num_steps", 50, "Num of steps [30]")
...
flags.DEFINE_integer("max_epoch", 30, "Total training epoches. [50]")
